...
exports.cpadminPasswordUpdatedMail = async (data) => {
  const { name, email, password } = data;
  try {
    const msg = {
      to: email,
      from: from_email,
      subject: "RICE N GRILLS - Password Updated",
                                                       ...
                                                       <tbody>
                                                           <tr>
                                                               <td class="column_cell px pte tc" style="box-sizing: border-box;vertical-align: top;width: 100%;min-width: 100%;padding-top: 32px;padding-bottom: 0px;font-family: Helvetica, Arial, sans-serif;font-size: 16px;line-height: 23px;color: #616161;mso-line-height-rule: exactly;text-align: center;padding-left: 16px;padding-right: 16px;">
                                                                   ...
                                                                   <h1 class="mb_xxs" style="color: #3e484d;margin-left: 0;margin-right: 0;margin-top: 20px;margin-bottom: 4px;padding: 0;font-weight: bold;font-size: 32px;line-height: 42px;">Password Updated</h1><br>
