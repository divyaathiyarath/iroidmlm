...
exports.newCpCreatedMail = async data => {
    const { name, email, password, asset_url, app_url } = data;
    ...
    emails.subject = `Your request has been approved`;
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#B80F0A">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="text-white-center" style="color:#ffffff; font-family:Arial,sans-serif, 'SSP'; font-size:14px; line-height:24px; text-align:center">
                                                        <p>Dear <span class="clr-56a9">${name}</span>
                                                        </p>
                                                        <p>Thank you for joining RiceNGrills.
                                                        </p>
                                                        <br>
                                                        <p>
                                                            Email ${email} <br/>Password ${password}</p>
                                                        <br>
                                                        <a class="mb-3 email-btn" href="${app_url}">Login to Collection Point Dashboard</a>
                                                        </div>
                                                        </div>
...
exports.newDriverCreatedMail = async data => {
    const { name, email, password, asset_url, app_url } = data;
    try {
        const msg = {
            to: email,
            from: from_email,
            subject: "RICE N GRILLS - Welcome New Delivery Partner",
            text: "Welcome New Delivery Partner",
            html: `      
        <!doctype html>
        <html lang="en">
        <head>
            ...
            .info-area,
            .faqs-content {
                border-bottom: 2px solid #23204D;
                margin: 25px 0;
            }
                    ...
                    <div class="logo">
                        ...
                        <nav class="navbar navbar-light">
                            <a class="navbar-brand" href="#">
                                <img src="${asset_url + '/images/logo.png'}" class="d-inline-block align-top" alt="RiceNGrills">
                            </a>
                        </nav>
                        <h1 class="title_main">Welcome to RiceNGrills</h1>
                    </div>
                    <div class="info-area mt-5">
                        <p>Dear <span class="clr-56a9">${name}</span>
                        </p>
                        <p>
                            Thank you for joining RiceNGrills.
                        </p>
                        <br>
                    </div>
                </div>
...
exports.cp_approved = async data =>{
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="text-white-center" style="color:#ffffff; font-family:Arial,sans-serif, 'SSP'; font-size:14px; line-height:24px; text-align:center">
                                                            <div class="text-white-center" style="color:#ffffff; font-family:Arial,sans-serif, 'SSP'; font-size:14px; line-height:24px; text-align:center">
                                                                Dear ${name}, <br>
                                                                <p>Congratulations, your application for RiceNGrills Collection Point has been approved.
                                                                One of our team members will contact you over the phone or email to let you know the next step.</p>  
                                                                <br>
                                                                <p>
                                                                Thank you for your interest in RiceNGrills. </p>
                                                                <br>
...
exports.cp_rejected = async data =>{
    const {name,email,asset_url,app_url} = data
    var api = require('../../api.js');
    ...
    emails.to = [emailRecipient];
    emails.from = emailFrom;
    emails.subject = `Your request has not been approved`;
    emails.body =`<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <!--[if gte mso 15]>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="text-white-center" style="color:#ffffff; font-family:Arial,sans-serif, 'SSP'; font-size:14px; line-height:24px; text-align:center">
                                                                    <div class="text-white-center" style="color:#ffffff; font-family:Arial,sans-serif, 'SSP'; font-size:14px; line-height:24px; text-align:center">
                                                                    Dear ${name}, <br>
                                                                    <p>Thank you for applying for the RiceNGrills Collection Point.
                                                                    After careful consideration, we will not be taking your application forward. </p>  
                                                                    <br>
                                                                    <p>Thank you for your interest in RiceNGrills. </p>
                                                                    <br>
                                                                    <p>Sincerely, </p>
                                                                    <p>RiceNGrills Team <p>
                                                                </div>
