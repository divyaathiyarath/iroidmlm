...
exports.driver_approved = async data => {
    const { name, email, asset_url } = data;
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#B80F0A">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        Dear ${name}, <br>
                                                        <p>Congratulations, your application for the post of Delivery Partner with RiceNGrills has been approved.
...
exports.driver_rejected = async data => {
    const { name, email, asset_url, admin_review } = data;
    var api = require('../../api.js');
    ...
    emails.to = [emailRecipient];
    emails.from = emailFrom;
    emails.subject = `Driver Request Rejected`;
    emails.body =`<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <!--[if gte mso 15]>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#B80F0A">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="text-white-center" style="color:#ffffff; font-family:Arial,sans-serif, 'SSP'; font-size:14px; line-height:24px; text-align:center">
                                                        Dear ${name}, <br>
                                                        <p>Thank you for applying for the Delivery Partner role.
                                                         After careful consideration, we will not be taking your application forward as we have had other candidates apply who more closely match the role requirements. </p>  
                                                        <br>
                                                        <p>If you have applied to other RiceNGrills roles, you will be notified separately about the outcome of those applications. </p>
                                                        <br>
                                                        <p>We will retain your details in our database and may contact you with future job opportunities that match your profile.  </p>
                                                        <br>
                                                        <p>Thank you for your interest in RiceNGrills. </p>
                                                        <br>
                                                        <p>Sincerely, </p>
