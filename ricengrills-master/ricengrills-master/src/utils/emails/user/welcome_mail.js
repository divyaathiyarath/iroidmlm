...
exports.welcomeMail = async data => {
    const { name, to_email, mobile } = data;
    ...
    email.subject = `WELCOME TO - ${config.PROJECT_NAME}`;
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#B80F0A">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="text-white-center" style="color:#ffffff; font-family:Arial,sans-serif, 'SSP'; font-size:14px; line-height:24px; text-align:center">
                                                          Dear ${name} , <br>
                                                          <p>Thank you for registering with RiceNGrills </p>
                                                          <p> ‘Rice N Grills’ intent to deliver premium quality meals at affordable price. RiceNGrills follows strict processes and procedures to ensure high quality standards. All raw material and food products go through rigorous quality checks.   </p>
                                                          <p>We only use fresh Vegetables and Halal certified chicken and meat sourced from the local market.  Production is done in our own kitchen in an extremely hygienic environment. We use minimum or no oil where ever possible and never reuse it. </p> 
