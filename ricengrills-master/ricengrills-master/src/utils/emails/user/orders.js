...
exports.order_confirmed = async data => {
    const { name, amount, to_email, products } = data;
    let product_html = "";
    ...
    email.subject = `${config.PROJECT_NAME} - Your order request has been confirmed`;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="text-white-center" style="color:#ffffff; font-family:Arial,sans-serif, 'SSP'; font-size:14px; line-height:24px; text-align:center">
                                                            Dear ${name}, <br>
                                                            <p>
                                                            Thank you for your order. Your order is now confirmed and the total cost is $${amount}.
                                                            This email contains a complete summary of your order. Please retain this confirmation for your records. 
                                                        </p>  
                                                        <br/>
                                                        <table>
                                                            <thead>
                                                                <tr>
                                                                    <td><u>Product</u></td>
                                                                    <td style="text-align:right;"><u>Count</u></td>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <tr>
...
exports.neworder_confirmed = async data => {
    const { name, to_email, order_id } = data;
    ...
    // attachment.content = pdfBuffer.toString();
    // attachment.type = "application/pdf";
    // attachment.filename = "invoice.pdf";
    // attachment.disposition = "attachment";
    // attachment.contentId = "invoice";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="text-white-center" style="color:#ffffff; font-family:Arial,sans-serif, 'SSP'; font-size:14px; line-height:24px; text-align:center">
                                                            Dear ${name}, <br>
                                                            <p>
                                                            Thank you for your order. Your order is now confirmed.
                                                            This email contains a complete summary of your order. 
                                                            Please retain this confirmation for your records. 
                                                        </p>
                                                        <br/>
                                                        <a href="${config.SITE_URL}generateinvoice/${order_id}"><button>Download Invoice</button></a>
                                                        <br/>
                                                        <p>Thanks and Regards, </p>
                                                        <p>RiceNGrills Team <p>
                                                        </div>
